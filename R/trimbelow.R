...
function (behavior,phaseX,v1,v2) {
  ...
  l1<-c("Chi-square trimmed mean below for behavior",'"',DV,'"')
  cat(sprintf(l1),"\n")
  writeLines(" ")
  ...
  print(ctbl)
  writeLines(" ")
  writeLines("Note: Intervention TRUE values below the trimmed mean line are desired.")
  ...
  plot(behavior,col="red",type="o",xlab="time",ylab=c(DV,"behavior"),main="Trimmed Mean Below Line")
